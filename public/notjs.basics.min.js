...
return f};c.prototype._editOnClick=function(b){"switchToFullInput"===this.options.formMode?this._showAllInputs():this._startInlineEdit(b);return b.$element.focus().select()};c.prototype._showAllInputs=function(){var b,d,a,c,f;c=this.formInputs;f=[];d=0;for(a=c.length;d<a;d++)b=c[d],b.$element.hasClass("readonly")?f.push(this._displayDataFor(b)):f.push(this._showInputFor(b));return f};c.prototype._showInputFor=function(b){b.formInputObject||(b.formInputObject=this._instantiateFormInputFor(b));return b.formInputObject.loadValue(this.dataObject)};
