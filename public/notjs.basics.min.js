...
this);this._findCancelButtons=a(this._findCancelButtons,this);this._findSaveButtons=a(this._findSaveButtons,this);this._hideSaveAndCancel=a(this._hideSaveAndCancel,this);this._showSaveAndCancel=a(this._showSaveAndCancel,this);this._instantiateFormInputFor=a(this._instantiateFormInputFor,this);this._showInputFor=a(this._showInputFor,this);this._showAllInputs=a(this._showAllInputs,this);this._editOnClick=a(this._editOnClick,this);this._installClickHandlers=a(this._installClickHandlers,this);this._initializeFormInputs=
a(this._initializeFormInputs,this);this.setFormMode=a(this.setFormMode,this);this.refresh=a(this.refresh,this);this.initialize=a(this.initialize,this);this.options=_.defaults(f,{formMode:"fullInput",updateCallback:this._defaultUpdateCallback});this.formInputs=[];return this}b.prototype.initialize=function(){this.$element=$(this.selector);this._initializeFormInputs();this.setFormMode(this.options.formMode);return this};b.prototype.refresh=function(){return setFormMode(this.options.formMode)};b.prototype.setFormMode=
function(c){this.options.formMode=c;switch(c){case "fullInput":return this._showAllInputs();case "inlineEdit":case "switchToFullInput":return this._displayDataForAll(),this._installClickHandlers();case "readOnly":return this._displayDataForAll();default:throw Notjs.errors.InvalidArgument("formMode");}};b.prototype._initializeFormInputs=function(){var c,e,a,b,g,d;this.formInputs=[];g=this.$element.find("[data-not_attr]");d=[];a=0;for(b=g.length;a<b;a++)c=g[a],c=$(c),e=c.data("not_type")||"Text",d.push(this.formInputs.push({$element:c,
type:e,attr:c.data("not_attr"),formInputClass:this._getClassFor(e),formInputObject:null}));return d};b.prototype._installClickHandlers=function(){var c,e,a,b,d,i=this;b=this.formInputs;d=[];e=0;for(a=b.length;e<a;e++)c=b[e],d.push(c.$element.click(function(){return i._editOnClick(c)}));return d};b.prototype._editOnClick=function(c){"switchToFullInput"===this.options.formMode?this._showAllInputs():this._showInputFor(c);return c.$element.focus().select()};b.prototype._showAllInputs=function(){var c,
e,a,b,d;b=this.formInputs;d=[];e=0;for(a=b.length;e<a;e++)c=b[e],d.push(this._showInputFor(c));return d};b.prototype._showInputFor=function(c){c.formInputObject||(c.formInputObject=this._instantiateFormInputFor(c));return c.formInputObject.loadValue(this.dataObject)};b.prototype._instantiateFormInputFor=function(c){return new c.formInputClass({container:c.$element,column:{field:c.attr},grid:this,gridPosition:0,position:0,item:dataObject,cancelChanges:this._cancelChanges,commitChanges:this._commitChanges})};
b.prototype._showSaveAndCancel=function(){};b.prototype._hideSaveAndCancel=function(){};b.prototype._findSaveButtons=function(){return this.$element.find("input[type='submit'], .success")};b.prototype._findCancelButtons=function(){};b.prototype._displayDataForAll=function(){var c,e,a,b,d;b=this.formInputs;d=[];e=0;for(a=b.length;e<a;e++)c=b[e],d.push(this._displayDataFor(c));return d};b.prototype._displayDataFor=function(c){var e,a,b;e=c.$element;b=c.formInputClass;a=c.attr;if(null!=b.formatForDisplay&&
_.isFunction(b.formatForDisplay))return e.html(b.formatForDisplay(e,e,this.dataObject[a],null,this.dataObject));console.warn("FormInput type "+c.type+" for "+a+" doesn't have a formatForDisplay class method. skipping")};b.prototype._defaultUpdateCallback=function(){};b.prototype._getClassFor=function(c){var e,a,b,d,i;if(Notjs.basics.formInputs[c])return Notjs.basics.formInputs[c];e=Notjs.globalNamespace();i=c.split(".");b=0;for(d=i.length;b<d;b++)a=i[b],e[a]?e=e[a]:thrown("Unable to find class for FormInput type "+
c+", specifically "+a);return e};b.prototype._commitChanges=function(){};b.prototype._cancelChanges=function(){};return b}()})}).call(this);
...
arguments)}b(d,e);d.formatForDisplay=function(a,b,c){return d._renderInput(c,!0)};d.prototype.initialize=function(){return this.$input=$(c.Checkbox._renderInput(!1,!1)).appendTo(this.$element).focus().select()};d.prototype.loadValue=function(a){return this.getDataObjectValue(a)?this.$input.attr("checked","checked"):this.$input.removeAttr("checked")};d.prototype.serializeValue=function(){return"checked"===this.$input.attr("checked")};d._renderInput=function(a,b){null==a&&(a=!1);null==b&&(b=!1);return"<input type='checkbox' "+
