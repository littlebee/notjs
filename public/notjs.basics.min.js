...
function(c,e,a){return c.prototype[e]||(c.prototype[e]=a)};e.prototype.errors={pureVirtualMissing:function(c,e){throw""+c+" pure virtual method "+e+" missing. Must override in subclass of FormInput.";},invalidArgument:function(c){throw"Invalid Argument: "+c;}};return e}.call(this);d.Notjs=new a}).call(this);(function(){Notjs.addPrototypeUnlessExists(Array,"remove",function(a,d){var b;b=this.slice((d||a)+1||this.length);this.length=0>a?this.length+a:a;return this.push.apply(this,b)})}).call(this);
(function(){var a=function(a,b){return function(){return a.apply(b,arguments)}};Notjs.namespace("basics",function(d){return d.Form=function(){function b(c,e,f){this.selector=c;this.dataObject=e;null==f&&(f={});this._cancelChanges=a(this._cancelChanges,this);this._commitChanges=a(this._commitChanges,this);this._getClassFor=a(this._getClassFor,this);this._defaultUpdateCallback=a(this._defaultUpdateCallback,this);this._displayDataFor=a(this._displayDataFor,this);this._displayDataForAll=a(this._displayDataForAll,
this);this._instantiateFormInputFor=a(this._instantiateFormInputFor,this);this._showInputFor=a(this._showInputFor,this);this._showAllInputs=a(this._showAllInputs,this);this._editOnClick=a(this._editOnClick,this);this._installClickHandlers=a(this._installClickHandlers,this);this._initializeFormInputs=a(this._initializeFormInputs,this);this.setFormMode=a(this.setFormMode,this);this.refresh=a(this.refresh,this);this.initialize=a(this.initialize,this);this.options=_.defaults(f,{formMode:"fullInput",updateCallback:this._defaultUpdateCallback});
this.formInputs=[];return this}b.prototype.initialize=function(){this.$element=$(this.selector);this._initializeFormInputs();this.setFormMode(this.options.formMode);return this};b.prototype.refresh=function(){return setFormMode(this.options.formMode)};b.prototype.setFormMode=function(c){this.options.formMode=c;switch(c){case "fullInput":return this._showAllInputs();case "inlineEdit":case "switchToEdit":return this._displayDataForAll(),this._installClickHandlers();case "readOnly":return this._displayDataForAll();
default:throw Notjs.errors.InvalidArgument("formMode");}};b.prototype._initializeFormInputs=function(){var c,e,a,b,d,g;this.formInputs=[];d=this.$element.find("[data-not_attr]");g=[];a=0;for(b=d.length;a<b;a++)c=d[a],c=$(c),e=c.data("not_type")||"Text",g.push(this.formInputs.push({$element:c,type:e,attr:c.data("not_attr"),formInputClass:this._getClassFor(e),formInputObject:null}));return g};b.prototype._installClickHandlers=function(){var c,e,a,b,d,g=this;b=this.formInputs;d=[];e=0;for(a=b.length;e<
a;e++)c=b[e],d.push(c.$element.click(function(){return g._editOnClick(c)}));return d};b.prototype._editOnClick=function(c){"switchToEdit"===this.options.formMode?this._showAllInputs():this._showInputFor(c);return c.$element.focus().select()};b.prototype._showAllInputs=function(){var c,e,a,b,d;b=this.formInputs;d=[];e=0;for(a=b.length;e<a;e++)c=b[e],d.push(this._showInputFor(c));return d};b.prototype._showInputFor=function(c){c.formInputObject||(c.formInputObject=this._instantiateFormInputFor(c));
return c.formInputObject.loadValue(this.dataObject)};b.prototype._instantiateFormInputFor=function(c){return new c.formInputClass({container:c.$element,column:{field:c.attr},grid:this,gridPosition:0,position:0,item:dataObject,cancelChanges:this._cancelChanges,commitChanges:this._commitChanges})};b.prototype._displayDataForAll=function(){var c,e,a,b,d;b=this.formInputs;d=[];e=0;for(a=b.length;e<a;e++)c=b[e],d.push(this._displayDataFor(c));return d};b.prototype._displayDataFor=function(c){var e,a,b;
e=c.$element;b=c.formInputClass;a=c.attr;if(null!=b.formatForDisplay&&_.isFunction(b.formatForDisplay))return e.html(b.formatForDisplay(e,e,this.dataObject[a],null,this.dataObject));console.warn("FormInput type "+c.type+" for "+a+" doesn't have a formatForDisplay class method. skipping")};b.prototype._defaultUpdateCallback=function(){};b.prototype._getClassFor=function(c){var e,a,b,d,g;if(Notjs.basics.formInputs[c])return Notjs.basics.formInputs[c];e=Notjs.globalNamespace();g=c.split(".");b=0;for(d=
g.length;b<d;b++)a=g[b],e[a]?e=e[a]:thrown("Unable to find class for FormInput type "+c+", specifically "+a);return e};b.prototype._commitChanges=function(){};b.prototype._cancelChanges=function(){};return b}()})}).call(this);
...
"serializeValue")};b.prototype.applyValue=function(c,e){return this.setDataObjectValue(c,e)};b.prototype.destroy=function(){return this.$element.html("")};b.prototype.focus=function(){return this.$element.focus()};b.prototype.getDataObjectValue=function(c){return Notjs.deepGet(c,this.attr)||""};b.prototype.setDataObjectValue=function(c,e){return Notjs.deepSet(c,this.attr,e)};return b}.call(this)})}).call(this);
...
this.options.hidePartials&&c.hide();return this};b.prototype.resolve=function(c){var e=this;null==c&&(c={});c=_.defaults(c,{onPartialsResolved:null});this.resolveExternal({onComplete:function(){e.resolveInPage();return e.onPartialsResolved(c.onPartialsResolved)}});return this};b.prototype.resolveInPage=function(){var c,e,a,b,d,g,j;e=this.$el.find('[data-not_partial^="#"]');d=0;for(g=e.length;d<g;d++)c=e[d],c=$(c),a=c.attr("data-not_partial"),b=a.slice(1),(a=null!=(j=this.inPagePartials[b])?j[0]:void 0)?
this.renderPartial(c,$(a).html()):console.error("In page partial not found by id "+b+" for element: ");return this};b.prototype.resolveExternal=function(c){var a,b,d,i,g;null==c&&(c={});c=_.defaults(c,{onComplete:null});this.externalsRes;b=this.$el.find('[data-not_partial*="/"]');if(0>=b.length&&"function"===typeof c.onComplete)c.onComplete();i=0;for(g=b.length;i<g;i++)a=b[i],a=$(a),d=a.attr("data-not_partial"),this.fetchExternalPartial(a,d,c);return this};b.prototype.fetchExternalPartial=function(c,
...
return this};b.prototype.getTemplate=function(){if(this.$template)return this.$template;this.$template=this.$element.clone();this.$element.html("");return this.$template};b.prototype.replicate=function(c,a){var b,d,i,g,j;this.$element.html("");i=g=0;for(j=c.length;g<j;i=++g)d=c[i],b=this.$template.clone(),(!a||a(b,d,i))&&this.$element.append(b);return this};return b}.call(this)})}).call(this);
...
(function(){Notjs.deepGet=function(a,d){var b,c,e,f,h;b=a;h=d.split(".");e=0;for(f=h.length;e<f;e++){c=h[e];if(null==b[c]){b=null;break}b=_.isFunction(b[c])?b[c]():b[c]}return b};Notjs.deepSet=function(a,d,b){var c,e,f,h;e=d.split(".");d=_.last(e);f=0;for(h=e.length;f<h;f++){c=e[f];if(null==a[c]){a=null;break}b=c===d?a=_.isFunction(a[c])?a[c]():a[c]:void 0}return _.isFunction(a[d])?a[d](b):a[d]=b};Notjs.keyCode={BACKSPACE:8,TAB:9,ENTER:13,ESCAPE:27,PAGEUP:33,PAGEDOWN:34,END:35,HOME:36,LEFT:37,UP:38,
RIGHT:39,DOWN:40,INSERT:45,DELETE:46}}).call(this);
(function(){var a=function(a,b){return function(){return a.apply(b,arguments)}},d={}.hasOwnProperty,b=function(a,b){function f(){this.constructor=a}for(var h in b)d.call(b,h)&&(a[h]=b[h]);f.prototype=b.prototype;a.prototype=new f;a.__super__=b.prototype;return a};Notjs.namespace("basics.formInputs",function(c){return c.Checkbox=function(c){function d(c){this.serializeValue=a(this.serializeValue,this);this.loadValue=a(this.loadValue,this);this.initialize=a(this.initialize,this);d.__super__.constructor.apply(this,
arguments)}b(d,c);d.formatForDisplay=function(a,c,b){return"<input type='checkbox' disabled='disabled' "+(b?"check='checked'":"")+"/>"};d.prototype.initialize=function(){return this.$input=$("<INPUT type=checkbox/>").appendTo(this.$element).focus().select()};d.prototype.loadValue=function(a){return this.getDataObjectValue(a)?this.$input.attr("checked","checked"):this.$input.removeAttr("checked")};d.prototype.serializeValue=function(){return"checked"===this.$input.attr("checked")};return d}.call(this,
