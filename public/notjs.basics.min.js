...
(function(){var a=function(a,c){return function(){return a.apply(c,arguments)}};Notjs.namespace("basics",function(g){return g.Form=function(){function c(b,d,e){this.selector=b;this.dataObject=d;null==e&&(e={});this._cancelChanges=a(this._cancelChanges,this);this._commitChanges=a(this._commitChanges,this);this._getClassFor=a(this._getClassFor,this);this._defaultUpdateCallback=a(this._defaultUpdateCallback,this);this._startInlineEdit=a(this._startInlineEdit,this);this._displayDataFor=a(this._displayDataFor,
this);this._displayDataForAll=a(this._displayDataForAll,this);this._findCancelButtons=a(this._findCancelButtons,this);this._findSaveButtons=a(this._findSaveButtons,this);this._hideSaveAndCancel=a(this._hideSaveAndCancel,this);this._showSaveAndCancel=a(this._showSaveAndCancel,this);this._instantiateFormInputFor=a(this._instantiateFormInputFor,this);this._showInputFor=a(this._showInputFor,this);this._showAllInputs=a(this._showAllInputs,this);this._editOnClick=a(this._editOnClick,this);this._installClickHandlers=
