...
return this._findCancelButtons().addClass("hidden").off("click.notjs-form")};c.prototype._findSaveButtons=function(){return this.$element.find("input[type='submit'], .success")};c.prototype._findCancelButtons=function(){return this.$element.find(".cancel")};c.prototype._startInlineEdit=function(b){if(!b.$element.hasClass("readonly"))return this._showInputFor(b),this._showSaveAndCancel(),this.inlineEditing=b};c.prototype._defaultUpdateCallback=function(){};c.prototype._getClassFor=function(b){var d,
a,c,f,h;if(Notjs.basics.formInputs[b])return Notjs.basics.formInputs[b];d=Notjs.globalNamespace();h=b.split(".");c=0;for(f=h.length;c<f;c++)if(a=h[c],d[a])d=d[a];else throw"Unable to find class for FormInput type "+b+", specifically "+a;return d};c.prototype._commitChanges=function(){var b,d,a,c,f;this.inlineEditing?(d=[this.inlineEditing],this.inlineEditing=!1):d=this.formInputs;a=[];c=0;for(f=d.length;c<f;c++)b=d[c],null!=b.formInputObject&&(b.formInputObject.applyValue(dataObject,b.formInputObject.serializeValue()),
a.push(b.attr));return this.options.updateCallback(a)};c.prototype._cancelChanges=function(){this.inlineEditing=!1;return this.refresh()};return c}()})}).call(this);
