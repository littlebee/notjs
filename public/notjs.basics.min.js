...
this);this._findSaveButtons=a(this._findSaveButtons,this);this._hideSaveAndCancel=a(this._hideSaveAndCancel,this);this._showSaveAndCancel=a(this._showSaveAndCancel,this);this._initializeSaveAndCancel=a(this._initializeSaveAndCancel,this);this._destroyFormInputObject=a(this._destroyFormInputObject,this);this._displayDataFor=a(this._displayDataFor,this);this._displayDataForAll=a(this._displayDataForAll,this);this._instantiateFormInputFor=a(this._instantiateFormInputFor,this);this._showInputFor=a(this._showInputFor,
this);this._showAllInputs=a(this._showAllInputs,this);this._editOnClick=a(this._editOnClick,this);this._removeClickHandlers=a(this._removeClickHandlers,this);this._installClickHandlers=a(this._installClickHandlers,this);this._initializeFormInputs=a(this._initializeFormInputs,this);this.setFormMode=a(this.setFormMode,this);this.refresh=a(this.refresh,this);this.initialize=a(this.initialize,this);this.options=_.defaults(f,{formMode:"fullInput",updateCallback:this._defaultUpdateCallback});this.formInputs=
[];return this}b.prototype.initialize=function(){this.$element=$(this.selector);this._initializeFormInputs();this._initializeSaveAndCancel();this.setFormMode(this.options.formMode);return this};b.prototype.refresh=function(){return this.setFormMode(this.options.formMode)};b.prototype.setFormMode=function(c){this.$element.hasClass("readonly")&&(c="readOnly");this.options.formMode=c;this.inlineEditing=!1;switch(c){case "fullInput":return this._removeClickHandlers(),this._showAllInputs(),this._showSaveAndCancel();
case "inlineEdit":case "fullInputOnClick":return this._displayDataForAll(),this._installClickHandlers(),this._hideSaveAndCancel();case "readOnly":return this._displayDataForAll(),this._removeClickHandlers(),this._hideSaveAndCancel();default:return Notjs.errors.invalidArgument("formMode")}};b.prototype._initializeFormInputs=function(){var c,e,a,b,g,d;this.formInputs=[];g=this.$element.find("[data-not_attr]");d=[];a=0;for(b=g.length;a<b;a++)c=g[a],c=$(c),e=c.data("not_type")||"Text",d.push(this.formInputs.push({$element:c,
type:e,attr:c.data("not_attr"),formInputClass:this._getClassFor(e),formInputObject:null}));return d};b.prototype._installClickHandlers=function(){var c=this;return _.each(this.formInputs,function(e){return e.$element.on("mouseup.notjs-form",function(){return c._editOnClick(e)})})};b.prototype._removeClickHandlers=function(){var c,e,a,b,d;b=this.formInputs;d=[];e=0;for(a=b.length;e<a;e++)c=b[e],d.push(c.$element.off("mouseup.notjs-form"));return d};b.prototype._editOnClick=function(c){return"fullInputOnClick"===
this.options.formMode?(this._showAllInputs(),this._showSaveAndCancel()):this._startInlineEdit(c)};b.prototype._showAllInputs=function(){var c,e,a,b,d;b=this.formInputs;d=[];e=0;for(a=b.length;e<a;e++)c=b[e],d.push(this._showInputFor(c));return d};b.prototype._showInputFor=function(c){if(c.$element.hasClass("readonly"))return this._displayDataFor(c);c.formInputObject||(c.$element.html(""),c.formInputObject=this._instantiateFormInputFor(c));return c.formInputObject.loadValue(this.dataObject)};b.prototype._instantiateFormInputFor=
function(c){return new c.formInputClass({container:c.$element,column:{field:c.attr},grid:this,gridPosition:0,position:0,item:dataObject,cancelChanges:this._cancelChanges,commitChanges:this._commitChanges})};b.prototype._displayDataForAll=function(){var c,e,a,b,d;b=this.formInputs;d=[];e=0;for(a=b.length;e<a;e++)c=b[e],d.push(this._displayDataFor(c));return d};b.prototype._displayDataFor=function(c){var e,a,b;e=c.$element;b=c.formInputClass;a=c.attr;if(null!=b.formatForDisplay&&_.isFunction(b.formatForDisplay))return this._destroyFormInputObject(c),
e.html(b.formatForDisplay(e,e,this.dataObject[a],null,this.dataObject));console.warn("FormInput type "+c.type+" for "+a+" doesn't have a formatForDisplay class method. skipping")};b.prototype._destroyFormInputObject=function(c){if(c.formInputObject)return c.formInputObject.destroy(),c.formInputObject=null};b.prototype._initializeSaveAndCancel=function(){this._findSaveButtons().on("mouseup.notjsForm",this._commitChanges);return this._findCancelButtons().on("mouseup.notjsForm",this._cancelChanges)};
b.prototype._showSaveAndCancel=function(){this._findSaveButtons().removeClass("hidden");return this._findCancelButtons().removeClass("hidden")};b.prototype._hideSaveAndCancel=function(){this._findSaveButtons().addClass("hidden");return this._findCancelButtons().addClass("hidden")};b.prototype._findSaveButtons=function(){return this.$element.find("input[type='submit'], .success")};b.prototype._findCancelButtons=function(){return this.$element.find(".cancel")};b.prototype._startInlineEdit=function(c){if(!c.$element.hasClass("readonly"))return this._showInputFor(c),
this._showSaveAndCancel(),this.inlineEditing=c};b.prototype._defaultUpdateCallback=function(){};b.prototype._getClassFor=function(c){var e,a,b,d,i;if(Notjs.basics.formInputs[c])return Notjs.basics.formInputs[c];e=Notjs.globalNamespace();i=c.split(".");b=0;for(d=i.length;b<d;b++)if(a=i[b],e[a])e=e[a];else throw"Unable to find class for FormInput type "+c+", specifically "+a;return e};b.prototype._commitChanges=function(){var c,e,a,b,d;this.inlineEditing?(e=[this.inlineEditing],this.inlineEditing=!1):
e=this.formInputs;a=[];b=0;for(d=e.length;b<d;b++)c=e[b],null!=c.formInputObject&&(c.formInputObject.applyValue(dataObject,c.formInputObject.serializeValue()),a.push(c.attr));this.refresh();return this.options.updateCallback(a)};b.prototype._cancelChanges=function(){this.inlineEditing=!1;return this.refresh()};return b}()})}).call(this);
...
return this};b.prototype.getTemplate=function(){if(this.$template)return this.$template;this.$template=this.$element.clone();this.$element.html("");return this.$template};b.prototype.replicate=function(c,a){var b,d,g,i,j;this.$element.html("");g=i=0;for(j=c.length;i<j;g=++i)d=c[g],b=this.$template.clone(),(!a||a(b,d,g))&&this.$element.append(b);return this};return b}.call(this)})}).call(this);
